...
//    String SERVER_URL = "https://apnamzp.in/";
    ...
    Call<List<OrderItem>> getAllOrders(@Query("shopCategory") String shopCategory,
                                       ...
                                       @Query("isMonthly") boolean isMonthly);

    @POST("/partner/order/updateStatus")
    Call<NetworkResponse> updateOrderStatus(@Query("orderId") String orderId,
                                            @Query("orderStatus") int orderStatus,
                                            @Query("shopReceivedPayment") boolean shopReceivedPayment);

    @POST("/partner/assignDeliveryBoy")
    Call<NetworkResponse> assignDeliveryBoy(@Query("orderId") String orderId,
    ...
    Call<NetworkResponse> acceptOrder(@Query("order_id") String order_id,
                                      @Query("user_id") String user_id,
                                      @Query("expected_time") String exptectedTime);

    @GET("/partner/reject_order")
    Call<NetworkResponse> rejectOrder(@Query("order_id") String order_id,
                                      @Query("user_id") String user_id,
                                      @Query("cancel_reason") String cancelReason);
    ...
    Call<NetworkResponse> updateMenuItem(@Query("shopItemsId") String shopItemsId,
                                         @Query("categoryName") String categoryName,
                                         @Query("isNewItem") boolean isNewItem,
                                         @Body ShopItemData shopItemData);

    @Multipart
    @POST("/partner/update/menuitem")
    Call<NetworkResponse> putMenuItem(@Query("deleteItem") boolean deleteItem,
                                      @Query("shopItemsId") String shopItemsId,
                                      @Query("categoryName") String categoryName,
                                      @Query("isNewItem") boolean isNewItem,
                                      @Part MultipartBody.Part itemImagePart,
                                      @Part("shopItemData") RequestBody shopItemData);

    @POST("/partner/createNewCategory")
    Call<NetworkResponse> addNewCategory(@Query("shopItemsId") String shopItemsId,
                                         @Body ShopCategoryData shopCategoryData);

    @Multipart
    @POST("/partner/update/shopdetails")
    Call<NetworkResponse> updateShopDetails(@Part MultipartBody.Part bannerImage,
                                            @Part("shopData") RequestBody shopData);
    ...
    Call<NetworkResponse> changeShopStatus(@Query("phoneNo") String phoneNo,
    ...
    Call<NetworkResponse> editCategories(@Query("action") String query,
                                         @Query("categoryName") String categoryName,
                                         @Query("shopItemsId") String shopItemsId,
    ...
    @POST("/partner/turnOffCategory")
    Call<NetworkResponse> turnOffCategory(@Query("shopItemId") String shopItemsId,
                                          @Query("categoryName") String categoryName);
